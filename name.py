...
# -----------------------------------------------------------------------------
# 3. 1.0% 기준 0.3%p 단위 구간 설정 (8개 다채로운 색상 구간)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# 8개 구간별 다채로운 스펙트럼 색상 매핑 (붉은 보라계열 -> 노랑 -> 밝은 녹색 -> 진한 파랑)
color_discrete_map = {
    '0.4% 미만': '#d73027',       # 붉은색 (가장 낮음)
    '0.4% ~ 0.7% 미만': '#f46d43', # 주황색
    '0.7% ~ 1.0% 미만': '#fdae61', # 연주황
    '1.0% ~ 1.3% 미만': '#fee08b', # 연노랑 (기준점 1.0% 구간)
    '1.3% ~ 1.6% 미만': '#d9ef8b', # 연연두
    '1.6% ~ 1.9% 미만': '#a6d96a', # 연두
    '1.9% ~ 2.2% 미만': '#66bd63', # 녹색
    '2.2% 이상': '#1a9850'        # 진한 녹색 (가장 높음)
}
